...
@section('title', 'Masuk Akun - CM SPORT')
@push('styles')
<style>
    :root {
        --primary-red: #e60023;
    ...
    .form-options { display:flex; justify-content:space-between; align-items:center; margin-bottom: 2.5rem; margin-top: 0.5rem; }
    .auth-remember { display:flex; align-items:center; gap:0.6rem; color: #555; font-weight:500; font-size: 0.9rem; cursor: pointer; user-select: none; }
    .auth-remember input { width: 18px; height: 18px; accent-color: var(--primary-red); border-radius: 4px; cursor: pointer; }
    
    .forgot-link { color: #666; font-size: 0.9rem; font-weight: 600; text-decoration: none; transition: 0.2s; border-bottom: 1px solid transparent; }
    .forgot-link:hover { color: var(--primary-red); border-color: var(--primary-red); }
        ...
        <div class="auth-card">
            <div class="auth-brand">
                ...
                <div class="brand-content">
                    <div class="brand-title">Upgrade Performa Olahraga Anda.</div>
                    <div class="brand-sub">Dapatkan akses ke koleksi peralatan olahraga premium dengan penawaran terbaik hanya untuk member.</div>
                    
                    <ul class="brand-features">
                        <li>
                            <svg class="brand-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M20 6L9 17l-5-5"/></svg>
                            Kualitas Original Terjamin 100%
                        </li>
                        <li>
                        ...
                        <li>
                            <svg class="brand-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z"/></svg>
            ...
            <div class="auth-panel">
                <div>
                    ...
                    <div class="auth-sub">Silakan masuk untuk melanjutkan belanja.</div>
                </div>
                ...
                <form method="POST" action="{{ route('login.post') }}">
                    ...
                    <div class="input-group">
                        ...
                        <input type="password" id="password" name="password" class="auth-input" placeholder="Masukkan password Anda" required>
                        <span class="input-icon">
